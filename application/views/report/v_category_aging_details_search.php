            ...
            <table class="table table-hover table-bordered">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="vertical-align: middle; text-align: right;"> <?=number_format($total_current_year_1_3,2,'.',',')?> </td>
                        <td style="vertical-align: middle; text-align: right;"> <?=number_format($total_current_year_4_6,2,'.',',')?> </td>
                        <td style="vertical-align: middle; text-align: right;"> <?=number_format($total_current_year_7_9,2,'.',',')?> </td>
                        <td style="vertical-align: middle; text-align: right;"> <?=number_format($total_current_year_10_12,2,'.',',')?> </td>
                        <td style="vertical-align: middle; text-align: right;"> <?=number_format($total_last_1_year,2,'.',',')?> </td>
                        <td style="vertical-align: middle; text-align: right;"> <?=number_format($total_last_2_year,2,'.',',')?> </td>
                        <td style="vertical-align: middle; text-align: right;"> <?=number_format($total_last_3_year,2,'.',',')?> </td>
                        <td style="vertical-align: middle; text-align: right;"> <?=number_format($total_last_4_year,2,'.',',')?> </td>
                        <td style="vertical-align: middle; text-align: right;"> <?=number_format($total_last_5_year,2,'.',',')?> </td>
                        <td style="vertical-align: middle; text-align: right;"> <?=number_format($total_last_6_year_above,2,'.',',')?> </td>
                        <td style="vertical-align: middle; text-align: right;"> <?=number_format($sum_total_outstanding,2,'.',',')?> </td>
