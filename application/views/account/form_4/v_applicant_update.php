<div class="form-group row">
    ...
    <div class="col-sm-5">
        <input type="input" name="name" class="form-control" placeholder="Nama pemohon" value="<?php echo set_value('name',$data_details['NAME'])?>">
...
<div class="form-group row">
    ...
    <div class="col-sm-5">
        <?php echo select_state(input_data('address_state',$data_details['STATE']))?>
