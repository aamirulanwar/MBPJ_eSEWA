...
<div class="form-group row">
    ...
    <div class="col-sm-5">
        <input type="input" name="address_1" class="form-control" placeholder="" value="<?php echo set_value('address_1',$data_details['APPLICANT_ADDRESS'])?>">
...
<!--        <textarea name="address" class="form-control" rows="5">--><?php //echo $data_details['APPLICANT_ADDRESS']?><!--</textarea>-->
...
<div class="form-group row">
    ...
    <div class="col-sm-5">
        <input type="text" name="business_experience" class="form-control-plaintext" placeholder="Pengalaman berniaga" value="<?php echo race($data_details['RACE'])?>">
    </div>
</div>
<div class="form-group row">
