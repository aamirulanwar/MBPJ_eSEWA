...
<div class="card card-accent-info">
    <div class="card-header">
        ...
        <?php if($this->auth->access_view($this->curuser,array(3018))):?>
        <div class="pull-right">
            <a href="/asset/add_asset_tenant_type" class="add-new"><i style="color: green" class="fa fa-plus-circle fa-lg"></i> Tambah</a>
        </div>
        <?php endif;?>
    </div>
    <div class="card-body">
            ...
            <table class="table table-hover table-bordered">
                ...
                if($data_list):
                    ...
                    foreach($data_list as $row):
                        ...
                        <tr>
                            <td><?php echo $i?></td>
                            <td><?php echo $row['TENANT_TYPE_NAME']?></td>
                            <td>
                                <?php
                            ...
                            <td class="text-center">
                                <?php if($this->auth->access_view($this->curuser,array(3019))):?>
